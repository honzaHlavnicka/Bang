...
import cz.honzaa.bang.pluginy.bang.karty.Hledi;
import cz.honzaa.bang.pluginy.bang.karty.Panika;
import cz.honzaa.bang.pluginy.bang.karty.Pivo;
import cz.honzaa.bang.pluginy.bang.karty.CatBalou;
import cz.honzaa.bang.pluginy.bang.karty.Bang;
import cz.honzaa.bang.pluginy.bang.karty.Mustang;
...
import cz.honzaa.bang.pluginy.bang.karty.Duel;
import cz.honzaa.bang.pluginy.bang.karty.Dynamit;
...
import cz.honzaa.bang.pluginy.bang.karty.OpetovnaPalba;
import cz.honzaa.bang.pluginy.bang.karty.Salon;
import cz.honzaa.bang.pluginy.bang.karty.Vedle;
import cz.honzaa.bang.pluginy.bang.karty.Vezeni;
import cz.honzaa.bang.pluginy.bang.postavy.BartCassidy;
import cz.honzaa.bang.pluginy.bang.postavy.JednoduchePostavy;
import cz.honzaa.bang.pluginy.bang.postavy.Jourdonnais;
import cz.honzaa.bang.pluginy.bang.postavy.KitCarlson;
import cz.honzaa.bang.pluginy.bang.postavy.LizaciPostava;
import cz.honzaa.bang.pluginy.bang.postavy.PaulRegret;
import cz.honzaa.bang.pluginy.bang.postavy.RoseDoolan;
import cz.honzaa.bang.pluginy.bang.postavy.SidKetchum;
import cz.honzaa.bang.pluginy.bang.postavy.WildWill;
import cz.honzaa.bang.pluginy.bang.zbrane.Remington;
import cz.honzaa.bang.pluginy.bang.zbrane.RevCarabine;
import cz.honzaa.bang.pluginy.bang.zbrane.Schofield;
import cz.honzaa.bang.pluginy.bang.zbrane.Volcanic;
import cz.honzaa.bang.pluginy.bang.zbrane.Winchester;
...
public class PravidlaBangu implements HerniPravidla{
    ...
    @Override
    public void pripravBalicekPostav(java.util.Stack<cz.honzaa.bang.sdk.Postava> balicekPostav){
    ...
    @Override
    public cz.honzaa.bang.sdk.UIPrvek[] getViditelnePrvky() {
        return cz.honzaa.bang.sdk.UIPrvek.values();
    }
