 ...
 * @author honza
 */
public class KomunikatorHryImp implements cz.honzaa.bang.sdk.KomunikatorHry{
    private HraImp hra;
    ...
    @Override
    @PovolenePluginu
    public void posliVsem(String co, cz.honzaa.bang.sdk.Hrac komuNe) {
        for (WebSocket conn : hraciPodleWebsocketu.keySet()) {
            if (conn != null && conn.isOpen()) {
    ...
    public synchronized void aktualizujAdmina() {
        List<cz.honzaa.bang.sdk.Hrac> hraci = hra.getHraci();
        if (hraci.isEmpty()) {
            admin = null;
            return;
        }
        ...
        for (cz.honzaa.bang.sdk.Hrac h : hraci) {
    ...
    @Override
    @PovolenePluginu
    public void posliOdebraniKarty(Hrac hrac, cz.honzaa.bang.sdk.Karta karta) {
        posliVsem("odehrat:" + hrac.getId() + "|" + karta.toJSON());
    }
    
    @Override
    @PovolenePluginu
    public void posliSpaleniKarty(Hrac hrac, cz.honzaa.bang.sdk.Karta karta) {
        posliVsem("spalit:" + hrac.getId() + "|" + karta.toJSON());
    }
    
    @Override
    @PovolenePluginu
    public void posliSpaleniVylozenéKarty(cz.honzaa.bang.sdk.Karta karta, Hrac odkud) {
    ...
    @Override
    @PovolenePluginu
    public CompletableFuture<String> pozadejOdpoved(String otazka,cz.honzaa.bang.sdk.Hrac komu) {
        //připravý si id:
    ...
    @Override
    @PovolenePluginu
    public void setAdmin(cz.honzaa.bang.sdk.Hrac admin) {
     ...
     */
    public void posliVsechnaUITlacitka(cz.honzaa.bang.sdk.Hrac komu) {
        HracImp hracImp = (HracImp) komu;
        Map<Integer, CustomUIButton> playerUI = customUIByPlayer.get(hracImp);
