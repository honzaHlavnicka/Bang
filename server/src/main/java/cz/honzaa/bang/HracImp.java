 ...
 * @author honza
 */
public class HracImp implements cz.honzaa.bang.sdk.Hrac{
    private static final Logger logger = LoggerFactory.getLogger(HracImp.class);
    private int zivoty;
    private int  maximumZivotu;
    private cz.honzaa.bang.sdk.Postava postava = null;
    ...
    private cz.honzaa.bang.sdk.Role role;
    private String jmeno;
    private cz.honzaa.bang.sdk.Postava[] postavyNaVyber;
    private Hra hra;
     ...
     */
    @Override
    public void priraditRoliNaZacatkuHry(cz.honzaa.bang.sdk.Role role) {
        this.role = role;
     ...
     */
    @Override
    public void vyberZPostav(cz.honzaa.bang.sdk.Postava p1, cz.honzaa.bang.sdk.Postava p2){
        postavyNaVyber = new cz.honzaa.bang.sdk.Postava[]{p1,p2};
    ...
    @Override
    @PovolenePluginu
    public cz.honzaa.bang.sdk.Role getRole() {
        return role;
    }

    @Override
    @PovolenePluginu
    public cz.honzaa.bang.sdk.Postava getPostava() {
        return postava;
    }    
    ...
    @Override
    @PovolenePluginu
    public Postava setPostava(cz.honzaa.bang.sdk.Postava postava) {
    ...
    @Override
    @PovolenePluginu
    public void setRole(cz.honzaa.bang.sdk.Role role) {
        this.role = role;
        hra.getKomunikator().posli(this, "role:" + role.name());
    }
    ...
    public void setPostava(String jmeno){
        for (cz.honzaa.bang.sdk.Postava postava : postavyNaVyber) {
    ...
    public void posliVyberPostav() {
        ...
        cz.honzaa.bang.sdk.Postava p1 = postavyNaVyber[0];
        cz.honzaa.bang.sdk.Postava p2 = postavyNaVyber[1];
        StringBuilder sb = new StringBuilder("vyberPostavu:[{\"jmeno\":\"");
        sb.append(p1.getJmeno());
        sb.append("\",\"obrazek\":\"");
        sb.append(p1.name());
     ...
     * @see #vzdalenostKCista(cz.honzaa.bang.Hrac) 
     */
    @Override
    @PovolenePluginu
     ...
     * @see #fyzickaVzdalenostK(cz.honzaa.bang.Hrac) 
     */
    @Override
    @PovolenePluginu
