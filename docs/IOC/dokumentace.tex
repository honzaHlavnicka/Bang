...
Jak již bylo zmíněno, tak klient je napsán pro framework \emph{React} pro web. Obsahuje hlavní soubor \texttt{main.tsx}, který obsahuje různé providery a celoaplikační komponenty. (zde bude odkaz na moduly) Hlavní komponentou celé aplikace je \texttt{App}, která přepíná mezi stránkami a řeší lazyloading. Jednotlivé stránky se nacházejí v \texttt{/src/pages/}.
