...
public interface Postava {
     ...
     * třeba přidat efekt hráčovi. Vše co se v této metodě změní, se musí vrátit v {@link #odebraniPostavy(cz.honzaa.bang.sdk.Hrac)}.
    ...
    /**
     * Akce, která se spustí při odebrání postavy. Měla by zrušit vše co zavedla metoda {@link #pridaniPostavy(cz.honzaa.bang.sdk.Hrac)},
