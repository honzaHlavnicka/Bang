...
public interface KomunikatorHry {
     ...
     * @see #posliVsem(java.lang.String, cz.honzaa.bang.sdk.Hrac) 
     */
    @PovolenePluginu
     ...
     * @see #posliVitezstvi(cz.honzaa.bang.sdk.Hrac) 
     */
    @PovolenePluginu
     ...
     * neukončí hru. Pro pořádnou tabulku výsledků a ukončení hry použijte metody {@link #posliVysledky(cz.honzaa.bang.sdk.Hrac[][])} a {@link #posliKonecHry()}
     * 
     * @param hrac Hráč, který vyhrál
     * @see #posliVysledky(cz.honzaa.bang.sdk.Hrac[][]) 
     * @see #posliKonecHry() 
     */
    @PovolenePluginu
     ...
     * @see #posliSpaleniVylozenéKarty(cz.honzaa.bang.sdk.Karta, cz.honzaa.bang.sdk.Hrac) 
     */
    @PovolenePluginu
     ...
     * @param hrac Hráč, jehož karta byla spálena
     * @param karta Spálená karta
     * @see #posliZmenuPoctuKaret(cz.honzaa.bang.sdk.Hrac) 
     */
    @PovolenePluginu
     ...
     * která by se měla poslat přes {@link #posliVysledky(cz.honzaa.bang.sdk.Hrac[][])}
     ...
     * 
     * @see #pozadejOVyberMoznosti(cz.honzaa.bang.sdk.Hrac, java.util.List, java.lang.String, boolean) pro výběr z možností
     * @see #pozadejOKarty(cz.honzaa.bang.sdk.Hrac, java.util.List, java.lang.String, int, int, boolean) pro výběr karet
     * @see #pozadejOText(cz.honzaa.bang.sdk.Hrac, java.lang.String, java.lang.String, java.lang.String, boolean) 
     */
    @PovolenePluginu
     ...
     * @return ID tlačítka
     * 
     * @see #smazatUI(cz.honzaa.bang.sdk.Hrac, int) 
     * @see HerniPravidla#uiButtonClicked(cz.honzaa.bang.sdk.Hrac, int)
     */
    @PovolenePluginu
     ...
     * @see #pridejUIButton(cz.honzaa.bang.sdk.Hrac, int, java.lang.String, boolean, java.lang.Runnable) 
     */
    @PovolenePluginu
     ...
     * @see #setAdmin(cz.honzaa.bang.sdk.Hrac) 
     */
    @PovolenePluginu
