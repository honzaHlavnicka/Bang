...
public interface HerniPravidla {    
     ...
     * @see #pripravitHrace(cz.honzaa.bang.Hrac)
     */
    @PovolenePluginu
     ...
     * @param co
     * @return 
     * @see #muzeSpalit(cz.honzaa.bang.sdk.Karta) 
     * @see #muzeZahrat(cz.honzaa.bang.sdk.Karta, cz.honzaa.bang.sdk.Hrac) 
     */
    @PovolenePluginu
     ...
     * @see cz.honzaa.bang.sdk.KomunikatorHry#pridejUIButton(cz.honzaa.bang.sdk.Hrac, int, java.lang.String, boolean, java.lang.Runnable)
     */
    @PovolenePluginu
