    ...
    return (
        <div className={css.container}>
            ...
            <div className={css.content}>
                ...
                <a href={"https://world-quiz.com/" + language + "/game/flags/europe" + "?utm_source=bang.honzaa.cz&utm_medium=referral&utm_campaign=bang&utm_campaign=po_dohrani_bangu_obrazek"} target="_blank" >
                    <img src="/img/world-quiz-obrazovka.png" alt="World quiz screenshot" style={{width:"100%",borderRadius:"8px"}} />
                </a>
                <p>{t("Pokud už ostatní nechtějí hrát a stále se nudíš, tak si protrénuj své zeměpisné znalosti na webu")} <a target="_blank" href={"https://world-quiz.com/" + language + "?utm_source=bang.honzaa.cz&utm_medium=referral&utm_campaign=bang&utm_campaign=po_dohrani_bangu"}>world-quiz.com</a>.</p>
                <p>{t("Největší online databáze vlajek:")} <a target="_blank" href={"https://jef.world-quiz.com/" + language + "?utm_source=bang.honzaa.cz&utm_medium=referral&utm_campaign=bang&utm_campaign=po_dohrani_bangu"}>jef.world-quiz.com</a>.</p>
            </div>
